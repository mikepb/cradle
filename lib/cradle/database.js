...
//
var Database = exports.Database = function(connection, name) {
    this.connection = connection;
    this.options = connection.options;
    this.name = querystring.escape(name);

    // The database document cache.
    this.cache = new cradle.Cache(this.options);
};
...
Database.prototype.search = function(options, callback) {
    this.get('/_search', options, callback);
};
...
// as we don't want users to confuse this functionwith `remove`.
